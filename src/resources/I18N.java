...
public final class I18N {
	...
	public static List<Locale> getSupportedLocales() {
		return new ArrayList<>(Arrays.asList(Locale.forLanguageTag("nl"), Locale.ENGLISH, Locale.FRENCH));
	}
	...
	public static Locale getDefaultLocale() {
		...
		// return getSupportedLocales().contains(sysDefault) ? sysDefault :
		// Locale.ENGLISH;
		return getSupportedLocales().contains(sysDefault) ? sysDefault : Locale.forLanguageTag("nl");
	}
